...
var dataInTable = []
var data = []
class BackwardDiviedDifferentialh extends Component
{ 
  constructor()
  {
    super();
...
/* ส่วนดึงข้อมูลจาก MongoDB */
    componentDidMount = async() => { 
        await api.getFunctionByName("BackwardDiviedDifferentialh").then(db => {
        this.setState({
  ...
  createTable(xcal,xreal,exprreal) 
  {
    ...
    return(
        <React.Fragment>
        <div width={10000}>
            <h1 style={Textstyle} className="text-white"> Backward Divied Differential(h)</h1>
      <Form>
          <br/>
          <Form.Row>
...
export default BackwardDiviedDifferentialh;
var Textstyle = {
  textAlign:'center',
