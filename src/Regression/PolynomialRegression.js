...
/*componentDidMount = async() => { 
    await api.getFunctionByName("PolynomialRegression").then(db => {
    this.setState({
    ...
    onSubmit()
  {
    ...
    /* this.setState({showTable:true,showGrap:true})
     this.createTable(this.state.x,y)*/
  }
  onReset ()
  {
  ...
  createTable(x,y,c) 
  {
    ...
    return(
        <React.Fragment>
        <div width={10000}>
            <h1 style={Textstyle} className="text-white"> Polynomial Regression </h1>
      <Form>
          <br/>
             <Form.Row>
                    ...
                    <Form.Group as={Col} controlId="Row">
                        ...
                        <Col sm="5">
                        <Form.Control type="text"   onChange={this.onChangestringx}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Col} controlId="Colum">
                        ...
                        <Col sm="5">
                            <Form.Control type="text"    onChange={this.onChangestringy}/>
                        </Col>
                    </Form.Group>
                    <Form.Group as={Col} controlId="Colum">
                        <Form.Label column sm="1"><h2 className="text-white">RequestX</h2></Form.Label>
                        <Col sm="5">
                            <Form.Control type="text"    onChange={this.onChangerequestX}/>
                        </Col>
                    </Form.Group>
            </Form.Row>
